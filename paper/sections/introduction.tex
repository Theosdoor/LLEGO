...
LLEGO (LLM-Enhanced Genetic Operators) \cite{astorga2025autoformulation} recently demonstrated that LLM-guided evolution 
...
\paragraph{Key considerations.} LLEGO \cite{astorga2025autoformulation} demonstrates value of semantic priors, through
fitness-guided crossover and 
